...
public class Beach : GameLocation
{
	...
	public override void DayUpdate(int dayOfMonth)
	{
		...
		while (Game1.random.NextDouble() < (double)chance)
		{
			...
			if (CanItemBePlacedHere(position3))
			{
	...
	public override void performTenMinuteUpdate(int timeOfDay)
	{
		...
		if (r.NextBool(0.25))
		{
			...
			{
				temporarySprites.Add(new TemporaryAnimatedSprite(151, 1500f, 1, 1, i.Position, flicker: false, flipped: false, verticalFlipped: false, 0f)
				{
