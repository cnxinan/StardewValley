...
public class Fence : Object
{
	...
	public virtual void toggleGate(bool open, bool is_toggling_counterpart = false, Farmer who = null)
	{
		...
		case 10:
		{
			...
			{
				fence2.toggleGate((int)gatePosition != 0, is_toggling_counterpart: true, who);
			}
			break;
		}
		case 1000:
		{
			...
			{
				fence3.toggleGate((int)gatePosition != 0, is_toggling_counterpart: true, who);
			}
			break;
		}
		case 500:
		{
			Vector2 neighborTile4 = tileLocation.Value + new Vector2(0f, -1f);
			...
			{
				fence4.toggleGate((int)gatePosition != 0, is_toggling_counterpart: true, who);
			}
			break;
		}
		}
