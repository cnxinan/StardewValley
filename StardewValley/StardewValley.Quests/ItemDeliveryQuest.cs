...
public class ItemDeliveryQuest : Quest
{
	...
	public void loadQuestInfo()
	{
		...
		case "Maru":
		{
			...
			parts.Clear();
			parts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ItemDeliveryQuest.cs." + (rand2 ? "13580" : "13583"), item));
			dialogueparts.Clear();
			dialogueparts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ItemDeliveryQuest.cs." + (rand2 ? "13585" : "13587")));
			break;
		}
		case "Abigail":
		{
