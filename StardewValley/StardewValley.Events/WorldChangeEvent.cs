...
public class WorldChangeEvent : BaseFarmEvent
{
	...
	public void resetForPlayerEntry(Point targetTile)
	{
		...
		case 15L:
		{
			...
			{
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Rectangle(184, 104, 14, 15), new Vector2(39 + l % 3, 34.1f + (float)(l / 3) * 0.5f) * 64f, flipped: false, 0f, Color.White)
				{
					animationLength = 1,
					interval = 700f,
					totalNumberOfLoops = 999,
