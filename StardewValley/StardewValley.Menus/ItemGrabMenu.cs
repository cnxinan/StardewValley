...
public class ItemGrabMenu : MenuWithInventory
{
		...
		case 0:
		{
			...
			if (showReceivingMenu)
			{
				...
				else
				{
					...
					currentlySnappedComponent = getComponentWithID(id + 53910 + diff2 / 2);
	...
	public override void receiveLeftClick(int x, int y, bool playSound = true)
	{
		...
		if (organizeButton != null && organizeButton.containsPoint(x, y))
		{
			...
			base.heldItem = null;
			ItemGrabMenu itemGrabMenu3 = new ItemGrabMenu(ItemsToGrabMenu.actualInventory, reverseGrab: false, showReceivingMenu: true, InventoryMenu.highlightAllItems, behaviorFunction, null, behaviorOnItemGrab, snapToBottom: false, canBeExitedWithKey: true, playRightClickSound: true, allowRightClick: true, showOrganizeButton: true, source, sourceItem, whichSpecialButton, context, HeldItemExitBehavior, AllowExitWithHeldItem).setEssential(essential);
